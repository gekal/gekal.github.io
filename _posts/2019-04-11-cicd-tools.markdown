...
3. [Concourse CI](https://concourse-ci.org/)
4. [Spinnaker](https://www.spinnaker.io/)
5. [Travis CI](https://travis-ci.org/)
6. [CircleCI](https://travis-ci.org/)
7. [AWS CodePipeline](https://aws.amazon.com/jp/codepipeline/)
8.  [Azure Pipelines](https://azure.microsoft.com/ja-jp/services/devops/pipelines/)
9.  [Continuous Delivery](https://cloud.google.com/solutions/continuous-delivery/)
