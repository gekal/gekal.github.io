    ...
    <footer className="bg-dark text-gray-400 py-10 mt-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="flex justify-center space-x-6 mb-6">
          <a
            href="https://twitter.com/GekalCn"
            target="_blank"
        ...
        <p className="text-sm mb-2">
          Copyright &copy; 鴻鷹 (gekal) {new Date().getFullYear()}
        </p>
        <p className="text-xs text-gray-600">
          Built with{' '}
          <Link href="https://nextjs.org" className="hover:text-gray-400 transition-colors">
            Next.js
          </Link>
          {' & '}
          <Link href="https://tailwindcss.com" className="hover:text-gray-400 transition-colors">
            Tailwind CSS
          </Link>
        </p>
      </div>
